...
if __name__ == '__main__':
    ...
    if os.path.exists(install_dir+"/"+hhsuitedb_info+"_hhsuite.done"):
        ...
        os.system("mkdir -p "+database_dir+"/"+hhsuitedb_info)
        ...
        direct_download(tool, address, database_dir+"/"+hhsuitedb_info)
        os.system("ln -s " + hhsuitedb_info + "_a3m.ffdata " + hhsuitedb_info+"_a3m_db")
        os.system("ln -s " + hhsuitedb_info + "_hhm.ffdata " + hhsuitedb_info + "_hhm_db")
