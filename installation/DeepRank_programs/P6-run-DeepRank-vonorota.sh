...
echo "perl /home/jianliu/DeepRank3/src/scripts/run_DeepRank_voronota.pl $targetid   $fasta  $model_dir  $outputfolder $contact_file $nativefile\n\n";								
perl /home/jianliu/DeepRank3/src/scripts/run_DeepRank_voronota.pl $targetid   $fasta  $model_dir  $outputfolder $contact_file $nativefile  2>&1 | tee  voronota.log
...
if [[ ! -f "$outputfolder/ALL_scores/feature_voronota.$targetid" ]];then 
	printf "!!!!! Failed to run voronota, check the installation </home/jianliu/DeepRank3/src/scripts/run_DeepRank_voronota.pl>\n\n"
else
