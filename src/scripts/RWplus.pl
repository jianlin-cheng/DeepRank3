...
=cut
 ...
 {
	 print "For CASP11\n";
	 print "This script calculate the RWplus score!\n";
	 print "perl $0 addr_CASP11_cal_not_norm_RWplus_score.pl addr_CASP11_norm_RWplus_score.pl addr_RWplus_folder dir_target_folder addr_seq addr_output addr_res";
	 print "for example:\n";
	 print "perl $0 CASP11_cal_not_norm_RWplus_score.pl CASP11_norm_RWplus_score.pl /home/rcrg4/tool/RWplus ../../test/test_target_prediction/T0516_test ../../test/casp9_seq/T0516.fasta ../../test/test_RWplus_final 123\n";
	 exit(0);
 }
