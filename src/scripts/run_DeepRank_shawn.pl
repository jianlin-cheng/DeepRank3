...
print "\n\n##### (1) Run feature generation\n\n";
print("perl $H_script/P1_feature_generation_parallel_shawn.pl $targetname $seqfile $dir_models $dir_output\n");
$status = system("perl $H_script/P1_feature_generation_parallel_shawn.pl $targetname $seqfile $dir_models $dir_output");
