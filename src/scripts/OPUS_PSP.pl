...
=cut
 ...
 {
	 print "For CASP11\n";
	 print "This script calculate the OPUS_PSP score!\n";
	 print "perl $0 addr_CASP11_cal_not_norm_OPUS_score.pl addr_CASP11_norm_OPUS_score.pl addr_OPUS_PSP_folder dir_target_folder addr_seq addr_output addr_res";
	 print "for example:\n";
...
#	 print "perl $0 CASP11_cal_not_norm_dfire_score.pl CASP11_norm_dfire_score.pl /home/rcrg4/tools/DFIRE2.1 ../../test/test_target_prediction/T0516_test ../../test/casp9_seq/T0516.fasta ../../test/test_dfire_final 123\n";
         print "perl $0 CASP11_cal_not_norm_OPUS_score.pl CASP11_norm_OPUS_score.pl /home/rcrg4/tools/OPUS/OPUS_PSP /home/rcrg4/Server/test/T0648-149804384417881-eva-data/filtered-T0648 /home/rcrg4/Server/test/T0648-149804384417881-eva-data/T0648 /home/rcrg4/Server/test/T0648-149804384417881-eva-data/13_feature_OPUS_PSP.T0648 123\n";
	 exit(0);
 }
