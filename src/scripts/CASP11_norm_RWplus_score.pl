...
###################################################################
  if (@ARGV != 3)
    { # @ARGV used in scalar context = number of args
	  ...
	  print "perl $PROGRAM_NAME addr_sequence(*.fasta) addr_not_normed_dfire_score(*.RWplus_score) addr_output\n";
	  
	  print "For example:\n\n";
	  print "perl $PROGRAM_NAME ../../test/casp9_seq/T0516.fasta ../../test/test_RWplus_score_T0516 ../../test/test_RWplus_score_T0516_normed\n";
	  exit(0);
	}
